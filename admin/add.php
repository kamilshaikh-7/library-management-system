            ...
            <div id="main">
                ...
                <div class="container" style="text-align:center">
                    ...
                    <form class="add-book-form" action="" method="post">
                        ...
                        <button class="btn btn-primary" style="width:200px;" type="submit" name="submit">Add</button>
                    </form>
                </div>
                ...
                if(isset($_POST['submit'])){
                    if(isset($_SESSION['login_admin'])){
                        mysqli_query($db, "INSERT INTO `books` VALUES ('$_POST[b_id]', '$_POST[name]', '$_POST[authors]', 
                        '$_POST[edition]', '$_POST[status]', '$_POST[quantity]', '$_POST[dept]')");
                        ...
                        ?>
                        <script type="text/javascript">
                            alert('You must be logged in as Admin to add new books!');
                        </script>
                        <?php
                    }
                }
