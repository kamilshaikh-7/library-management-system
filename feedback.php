...
<body>
    <div class="wrapper">
        ...
        <section>
            ...
            <div class="container book-req-container" style="background-color: rgba(0, 0, 0, 0.6); width:1050px; padding:55px;  height: 700px;">
                <h2>If you have any suggestions or query please write down.</h2>
                                ...
                                if(mysqli_query($db,$sql)){
                                    ...
                                    $res = mysqli_query($db,$q);
                                        ...
                                        while($row = mysqli_fetch_assoc($res)){
                                            ...
                                            // else if($row['userName']==$_SESSION['login_admin']){
